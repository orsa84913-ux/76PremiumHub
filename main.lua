...
ScreenGui.Name = "76_Premium_Ultimate_Toggle"
...
DashGrad.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(240, 148, 51)), ColorSequenceKeypoint.new(1, Color3.fromRGB(188, 24, 136))})
DashGrad.Rotation = 45
local DashCont = Instance.new("Frame", DashBtn)
DashCont.Size = UDim2.new(1, 0, 1, 0)
DashCont.BackgroundColor3 = Color3.fromRGB(156, 156, 156)
DashCont.BackgroundTransparency = 0.5
...
LogoBtn.Size = UDim2.new(0, 45, 0, 45); LogoBtn.Position = UDim2.new(0.05, 0, 0.45, 0); LogoBtn.BackgroundColor3 = Color3.fromRGB(255, 255, 255); LogoBtn.Text = "76"; LogoBtn.TextColor3 = Color3.fromRGB(255, 255, 255); LogoBtn.Font = "GothamBold"; LogoBtn.Visible = false
Instance.new("UICorner", LogoBtn).CornerRadius = UDim.new(1, 0)
local LGrad = Instance.new("UIGradient", LogoBtn); LGrad.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(40, 20, 50)), ColorSequenceKeypoint.new(1, Color3.fromRGB(255, 120, 60))}); LGrad.Rotation = 90
...
local T2 = Instance.new("TextLabel", MainFrame); T2.Text = "Hileler"; T2.Size = UDim2.new(0, 200, 0, 20); T2.Position = UDim2.new(0.05, 0, 0.14, 0); T2.TextColor3 = Color3.fromRGB(200, 200, 200); T2.Font = "GothamMedium"; T2.TextXAlignment = "Left"; T2.BackgroundTransparency = 1
...
-- [[ SCRIPT EKLEME & TOGGLE MODAL ]]
local SelectedScript = nil; local SelectedStroke = nil
local function AddScript(name, code)
    local btn = Instance.new("TextButton", Scroll)
    btn.Size = UDim2.new(1, 0, 0, 35); btn.BackgroundColor3 = Color3.fromRGB(255, 255, 255); btn.BackgroundTransparency = 0.95; btn.Text = name; btn.TextColor3 = Color3.fromRGB(240, 240, 240); btn.Font = "Gotham"
...
local AddFrame = Instance.new("Frame", MainFrame)
AddFrame.Size = UDim2.new(0.45, 0, 0, 0); AddFrame.Position = UDim2.new(0.51, 0, 0.28, 0); AddFrame.BackgroundColor3 = Color3.fromRGB(30,30,35); AddFrame.ClipsDescendants = true; AddFrame.Visible = false; Instance.new("UICorner", AddFrame).CornerRadius = UDim.new(0, 15)

local NameBox = Instance.new("TextBox", AddFrame)
NameBox.Size = UDim2.new(0.9, 0, 0, 30); NameBox.Position = UDim2.new(0.05, 0, 0.1, 0); NameBox.PlaceholderText = "Hile Adı..."; NameBox.Text = ""; NameBox.BackgroundColor3 = Color3.fromRGB(50,50,55); NameBox.TextColor3 = Color3.fromRGB(255,255,255); Instance.new("UICorner", NameBox)

local CodeBox = Instance.new("TextBox", AddFrame)
CodeBox.Size = UDim2.new(0.9, 0, 0, 60); CodeBox.Position = UDim2.new(0.05, 0, 0.35, 0); CodeBox.PlaceholderText = "Hile Kodu..."; CodeBox.Text = ""; CodeBox.BackgroundColor3 = Color3.fromRGB(50,50,55); CodeBox.TextColor3 = Color3.fromRGB(255,255,255); CodeBox.TextWrapped = true; CodeBox.ClearTextOnFocus = false; Instance.new("UICorner", CodeBox)

local ConfirmAdd = Instance.new("TextButton", AddFrame)
ConfirmAdd.Size = UDim2.new(0, 100, 0, 30); ConfirmAdd.Position = UDim2.new(0.5, -50, 0.8, 0); ConfirmAdd.Text = "Ekle"; ConfirmAdd.BackgroundColor3 = Color3.fromRGB(255, 120, 60); ConfirmAdd.TextColor3 = Color3.fromRGB(255,255,255); Instance.new("UICorner", ConfirmAdd)

local AddTrigger = Instance.new("TextButton", Scroll)
AddTrigger.Size = UDim2.new(1, 0, 0, 35); AddTrigger.BackgroundColor3 = Color3.fromRGB(255, 255, 255); AddTrigger.BackgroundTransparency = 0.9; AddTrigger.Text = "+"; AddTrigger.TextColor3 = Color3.fromRGB(255, 255, 255); AddTrigger.TextSize = 20; Instance.new("UICorner", AddTrigger).CornerRadius = UDim.new(0, 8)

local isPanelOpen = false
AddTrigger.MouseButton1Click:Connect(function()
    if isPanelOpen then
        AddFrame:TweenSize(UDim2.new(0.45, 0, 0, 0), "In", "Quad", 0.2, true)
        task.wait(0.2); AddFrame.Visible = false
        isPanelOpen = false
    else
        AddFrame.Visible = true; AddFrame:TweenSize(UDim2.new(0.45, 0, 0.65, 0), "Out", "Quad", 0.3, true)
        isPanelOpen = true
    end
end)
...
ConfirmAdd.MouseButton1Click:Connect(function()
    if NameBox.Text ~= "" and CodeBox.Text ~= "" then
        AddScript(NameBox.Text, CodeBox.Text)
        AddFrame:TweenSize(UDim2.new(0.45, 0, 0, 0), "In", "Quad", 0.2, true)
        task.wait(0.2); AddFrame.Visible = false
        NameBox.Text = ""; CodeBox.Text = ""; isPanelOpen = false
        AddTrigger.Parent = nil; AddTrigger.Parent = Scroll
    end
end)
